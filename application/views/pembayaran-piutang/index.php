...
<div class="main-content">
	<section class="section">
		...
		<div class="section-body">
			...
			<p class="section-lead">Data Pembayaran Piutang</p>
                                        ...
                                        <?php foreach ($pembayaran_piutang as $p): ?>
											<tr>
												...
												<td class="text-center">
                                                    <?php if ($p->status != 1): ?>
														<a href="<?php echo base_url('pembayaran-piutang/edit/' . $p->id_pembayaran_piutang); ?>" class="btn btn-light" data-toggle="tooltip" title="Edit">
															<i class="fa fa-edit"></i>
														</a>
														<a href="#" class="btn btn-light" onclick="showConfirmDelete('pembayaran-piutang', <?php echo $p->id_pembayaran_piutang; ?>)" data-toggle="tooltip" title="Hapus">
