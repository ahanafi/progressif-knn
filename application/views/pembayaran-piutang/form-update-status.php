...
<div class="main-content">
	<section class="section">
		...
		<div class="section-body">
			...
			<form action="<?php echo base_url('pembayaran-piutang/edit-status/' . $pembayaran->id_pembayaran_piutang); ?>" method="post">
				<div class="row">
						...
						<div class="card card-primary">
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<select onchange="showNotaByPelanggan(this)" name="id_pelanggan" required class="form-control select2" id="id_pelanggan" disabled>
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<input type="text" required class="form-control form-money" name="jumlah" id="jumlah" placeholder="Jumlah" onkeyup="formatRupiah(this)" value="<?= toRupiah($pembayaran->jumlah) ?>" autocomplete="off" readonly>
								...
								<div class="form-group row mt-3">
									...
									<div class="col-sm-3">
										<input type="number" class="form-control form-money" id="potongan-lainnya" readonly name="potongan_lain_lain" placeholder="Potongan lain-lain" value="<?= toRupiah($pembayaran->potongan_lain_lain) ?>" autocomplete="off">
