                                    ...
                                    <?php if (count($pelanggans) > 0): ?>
                                        <?php foreach ($pelanggans as $pelanggan): ?>
											<tr>
												...
												<td class="format-uang"><a href="#" onclick="showDetails('piutang-lama', <?php echo $pelanggan->id_pelanggan; ?>)">Rp. <?php echo toRupiah($pelanggan->piutang_lama); ?></a></td>
												...
												<td class="format-uang"><a href="#" onclick="showDetails('lain-lain', <?php echo $pelanggan->id_pelanggan; ?>)">Rp. <?php echo ($pelanggan->lain_lain > 0) ? toRupiah($pelanggan->lain_lain) : 0; ?></a></td>
