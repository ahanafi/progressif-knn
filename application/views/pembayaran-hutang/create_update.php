...
<div class="main-content">
	<section class="section">
		...
		<div class="section-body">
			...
			<form action="<?php echo base_url('pembayaran-hutang/create'); ?>" method="post">
				<div class="row">
						...
						<div class="card card-primary">
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<input type="text" required class="form-control" name="no_giro_cek" placeholder="Nomor Giro/Cek" value="<?= set_value('no_giro_cek') ?>" autocomplete="off">
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<input type="text" required class="form-control form-money" name="jumlah" id="jumlah" placeholder="Jumlah" onkeyup="formatRupiah(this)" value="<?= set_value('jumlah') ?>" autocomplete="off">
									...
									<table class="table table-bordered" id="table-form">
										...
										<tbody id="list-item">
											<tr data-index="1">
												...
												<td>
													<input data-tanggal="0" width="120px" readonly type="date" name="tanggal_nota[]" class="form-control tanggal-nota tanggal_nota_1" autocomplete="off">
												...
												<td>
													<select name="no_retur[]" onchange="getTotal(this, 'retur', 1)" class="form-control list-retur no_retur_1 select2">
								...
								<div class="text-right">
									<button name="submit" disabled class="btn btn-primary mr-1" id="btn-submit" type="submit">Simpan Data</button>
								</div>
							</div>
						</div>
					</div>
