...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form action="<?php echo base_url('retur-penjualan/edit/' . $retur->id_retur_penjualan); ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="card card-primary">
                            <div class="card-body">
								...
								<div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">Upload</label>
                                    <div class="col-sm-9">
					...
					<div class="col-12 col-md-6 col-lg-6">
                        <div class="card card-primary">
							<div class="card-header">
								<h4 class="card-title">File Retur Penjualan Saat ini</h4>
							</div>
                            <div class="card-body">
								<?php if($retur->file_retur != '' && file_exists(FCPATH . '/uploads/retur-penjualan/' . $retur->file_retur)):?>
									<iframe src="<?php echo base_url('uploads/retur-penjualan/' . $retur->file_retur); ?>" width="100%" height="360px">
									This browser does not support PDFs. Please download the PDF to view it:
								<?php else: ?>
									<h3 class="text-info">Tidak ada dokumen retur penjualan</h3>
								<?php endif; ?>
                            </div>
                        </div>
                    </div>
