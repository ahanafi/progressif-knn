...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form action="<?php echo base_url('retur-penjualan/create'); ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="no_retur"
                                               value="<?php echo set_value('no_retur'); ?>" class="form-control text-uppercase"
                                               placeholder="Masukkan nomor Retur Penjualan" autocomplete="off">
