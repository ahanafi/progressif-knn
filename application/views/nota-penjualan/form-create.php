...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form action="<?php echo base_url('nota-penjualan/create'); ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="no_nota"
                                               value="<?php echo set_value('no_nota'); ?>" class="form-control text-uppercase" placeholder="Masukkan nomor Nota" autocomplete="off">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="id_sales" required class="form-control select2">
                                            ...
                                            <?php foreach ($sales as $s): ?>
                                                <option <?= (set_value('id_sales') == $s->id_sales) ? 'selected' : ''; ?> value="<?php echo $s->id_sales; ?>"><?php echo strtoupper($s->nama_sales); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="text-right">
									...
									<a href="<?php echo  base_url('nota-penjualan'); ?>" class="btn btn-secondary">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
