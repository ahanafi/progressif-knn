    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if (showOnlyTo('1')): ?>
                ...
                <li class="dropdown <?= $uri1 === 'data-testing' || $uri1 === 'uji-penentuan' ? 'active' : ''; ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="<?= $uri1 == 'uji-penentuan' ? 'active' : ''; ?>">
                            <a class="nav-link" href="<?= base_url('uji-penentuan'); ?>">Uji Penentuan</a>
                        </li>
                    </ul>
                </li>
            <?php endif ?>
