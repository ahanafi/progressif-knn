...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form action="<?php echo base_url('jenis-bayar/create'); ?>" method="post">
                <div class="row">
                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="nama_jenis_bayar" value="<?php echo set_value('nama_jenis_bayar'); ?>" class="form-control" placeholder="Nama Jenis Bayar" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="keterangan" required cols="30" rows="5" class="form-control" placeholder="Keterangan"><?php echo set_value('keterangan'); ?></textarea>
